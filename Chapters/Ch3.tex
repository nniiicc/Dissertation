...
\begin{figure}
\includegraphics[width=4in, height=2.5in]{ICOADS-Coding}
\end{figure}
\textbf{Outcomes}\\ 
...
\begin{figure}
\includegraphics[width=4in, height=2.5in]{icoads-poster}
\end{figure}\\
...
\begin{tabular}{|l|l|}
\hline
\textbf{Variable Name} & \textbf{Data Type} \\ \hline
Begin date & Text \\ \hline
End Date & Text \\ \hline
Governance scale & Categorical \\ \hline
Multiple levels & Categorical \\ \hline
Institutional diversity & Ordinal \\ \hline
Centralization & Ordinal \\ \hline
Description & Text \\ \hline
Causal level & Categorical \\ \hline
Selective Pressure & Categorical \\ \hline
Governance trigger & Categorical \\ \hline
Knowledge type & Categorical \\ \hline
External recognition & Ordinal \\ \hline
Metric diversity & Ordinal \\ \hline
Policy instrument & Categorical \\ \hline
Scale match & Binary \\ \hline
\end{tabular}
}
\end{table}
...
\begin{tabular}{|l|l|}
\hline
\textbf{Type} & Whether the variable is measured at the (1) interval, (2) ordinal, (3) categorical, or (4) open-text level. \\ \hline
\textbf{Component Type} & What type of component in the Knowledge Commons (e.g. Background Environment, Attribute, Action Arena, etc) the variable describes. \\ \hline
\textbf{Question} & What question(s) is posed to the user when they are measuring the variable for a case study \\ \hline
\textbf{Select options} & The range of values that the variable can have \\ \hline
\textbf{Unit} & For interval variables, the unit of measurement. \\ \hline
\textbf{Role} & Records whether the variable describes components with a particular role (e.g. users, producers, provisioners, etc) \\ \hline
\textbf{Importance} & Describes the theoretical implications, as well as the meaningful interpretations of the variable selections \\ \hline
\textbf{Definition} & Provides a basic definition of the variable and what it is meant to achieve \\ \hline
\textbf{Domain} & Records what sector(s) (e.g. scientifc; cultural; etc) the variable is associated with, if it is specific to a particular sector. \\ \hline
\end{tabular}
}
\end{table}

Each variable is further defined by the properties for that particular variable. This information can be found in Appendix A.  
